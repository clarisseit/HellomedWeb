    ...
    return (
        <>
            ...
            >
                ...
                <footer className="bg-gray-800 text-white mt-[84rem] py-8">
            ...
            <div className="relative bg-green-200 p-4">
                <footer className="bg-gray-800 text-white py-8">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="flex justify-center mt-12 gap-4">
                            <a href="https://twitter.com/Lands_Rwanda" className="bg-green-200 text-black rounded-lg p-2">
                                <CiTwitter className='w-[2rem] h-[2rem]' />
                            </a>
                            <a href="https://www.facebook.com/LandsRwanda/?_rdc=1&_rdr" className="bg-green-200 text-black rounded-lg p-2">
                                <SlSocialFacebook className='w-[2rem] h-[2rem]' />
                            </a>
                            <a href="https://www.youtube.com/channel/UCspreo0XuFJzUDpMFbn-6xA/videos" className="bg-green-200 text-black rounded-lg p-2">
                                <CiYoutube className='w-[2rem] h-[2rem]' />
                            </a>
                            <a href="https://www.flickr.com/photos/138414661@N03/albums/" className="bg-green-200 text-black rounded-lg p-2">
                                <LiaFlickr className='w-[2rem] h-[2rem]' />
                            </a>
                        </div>
                        ...
                        <div className="mt-8">
                            <iframe
                                ...
                                title="Google Maps - Kimironko"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3978.3284606726827!2d30.1324037!3d-1.9365336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x19dca72e81a9b577%3A0x6736ab1d117265a5!2sKimironko+Kwa+Mushimire!5e0!3m2!1sen!2srw!4v1692902911291!5m2!1sen!2srw"
                                style={{ border: 0 }}
                                allowFullScreen=""
                                loading="lazy"
                            ></iframe>
                        ...
                        <div className="text-center mt-4">
                            <p>&copy; {new Date().getFullYear()} Hellomed Inc. All rights reserved.</p>
                        </div>
                    </div>
                </footer>
            </div>
